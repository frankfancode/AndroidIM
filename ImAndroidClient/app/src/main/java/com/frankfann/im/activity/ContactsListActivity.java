...
import com.frankfann.im.adapter.BaseListAdapter;
...
public class ContactsListActivity extends BaseActivity {
    ...
    private void getOnlineContacts() {
        try {
            ...
            APP.getSelf().getEBus().register(mContext, ChatCommand.GET_CONTACTS_USERID_RANDOM, chatRequest.messagekey);
        } catch (Exception e) {
    ...
    private class ContactsListAdapter extends BaseListAdapter {
        ...
        protected View getItemView(View convertView, int position) {
            ...
            if (StringUtils.equals(APP.getSelf().getUserInfo().userid, c.userid)) {
